/**
 * $Id: Template.js 2025-04-18 19:49:18 +0200 .m0rph $
 *
...
exports.breadcrumbs = (url, data) => {
   let [crumb, text, links, out] = ['', '', '', copyright(data.toString())]; // Convert to String object !!!
   if (url != '/') {
      ...
      if (url.startsWith('/about')) {
         ...
         if (url.endsWith('/') && (url.match(/\//g) || []).length > 2) {
            ...
            crumb = url.slice(0, url.lastIndexOf('/') + 1);
